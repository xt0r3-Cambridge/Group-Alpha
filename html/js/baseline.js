...
//function baseline(tokens){
    ...
    pitfalls[4] = new Pitfall(['hyperbole',[['REVOLUTIONARY'],['GROUNDBREAKING'],['MILLIONS','OF'],['MILLION'],['AI','SWOOPS'],['AI','SWOOPING'],['ARTIFICIAL','INTELLIGENCE','SWOOPS'],['ARTIFICIAL','INTELLIGENCE','SWOOPING'],['BEST','IN','THE','WORLD'],['TAUGHT','ITSELF'],['IS','A','THREAT'],['WILL','CONTROL'],['RADICAL']],[0,0,1,0,3,3,3,3,1,1,1,1,0],0]);
